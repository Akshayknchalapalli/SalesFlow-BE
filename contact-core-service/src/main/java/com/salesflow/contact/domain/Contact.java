...
@Entity
@Table(name = "contacts", schema = "contact_data")
@Data
...
public class Contact extends BaseEntity {
    ...
    @ElementCollection
    @CollectionTable(name = "contact_addresses", schema = "contact_data", 
                    joinColumns = @JoinColumn(name = "contact_id"))
    private Set<Address> addresses = new HashSet<>();

    @ElementCollection
    @CollectionTable(name = "contact_social_profiles", schema = "contact_data", 
                    joinColumns = @JoinColumn(name = "contact_id"))
